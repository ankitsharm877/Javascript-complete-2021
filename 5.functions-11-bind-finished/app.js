...
//Function Expression: functions stored as constant
const fun = function start() {
  console.log('start');
}
...
function defaultValue(a, b = 1) {
  console.log('default value', a, b);
}
defaultValue(2);
...
// alternative of rest parameters
const substractUp = () => {
  let substract = 0;
